...
function ListItemLink(props) {
      ...
      const renderLink = React.useMemo(
        () => React.forwardRef((itemProps, ref) => <RouterLink to={'lecture/'+to} ref={ref} {...itemProps} />),
        [to],
      );
                                ...
                                <HashRouter>
                                    <List component="nav">
                                        {mod.capsules.map((cap, j) => (
                                            <ListItemLink primary={i+'.'+j+' '+cap.title} to={cap.to} />
                                        ))}
                                    </List>
                                </HashRouter>
                            </Paper>
...
export default withStyles(classes)(Modules);